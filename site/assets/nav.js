...
function mountNav(active){
  ...
  const before=[['index.html','Leaderboard'],['compare.html','Compare'],['community.html','Community']], after=[['games.html','Seasons'],['methodology.html','Methodology'],['changelog.html','Changelog']];
